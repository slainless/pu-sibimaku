...
<html>
    <head>
        ...
        <title>SIBIMA-KU | Maintenance</title>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="home-wrapper">
                            ...
                            <h2 class="home-text text-uppercase">Fitur sedang dalam pengembangan</h2>
                            <h4>Tolong melapor jika anda menemukan bug, terima kasih.</h4>
                        </div>
                    </div>
                </div>
            </div>
