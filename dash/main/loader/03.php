...
<button class="btn btn-rounded btn-primary waves-effect waves-light trigger pull-right m-t-m-25 clearfix" data-toggle="modal" data-target="#panel-modal" value="3" type="button" data-primary="<?php echo codeGen("b","3"); ?>" data-mode="<?php echo codeGen("9","5"); ?>">Edit</button>
