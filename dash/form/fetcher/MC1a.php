...
$pdf->Ln(7);
	...
	$pdf->cell(7,5,"2.");
	$pdf->Indent(7);
	$pdf->WriteHTML("Pembayaran Sertifikat Bulanan <b>(MC) No. 01 s/d 02 (April s/d Mei 2017)</b> yang menyatakan pekerjaan telah mencapai <b>89,12 %</b> atau sebesar <b>Rp. 2.761.866.767,85 (Dua milyar tujuh ratus enam puluh satu juta delapan ratus enam puluh enam ribu tujuh ratus enam puluh tujuh rupiah koma delapan lima)</b>");
