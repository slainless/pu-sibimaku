...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var datas = [20, 30, 15];
		var colors = ["#f9cd48", "#26c6da", "#80deea"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#f9cd48']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ["#3bafda", "#26c6da", "#80deea", "#f9cd48"];
